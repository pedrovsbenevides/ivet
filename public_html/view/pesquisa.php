        ...
        <fieldset class="pesquisa parte1">
          ...
          <span class="field" id="field_trecho">
            <table class="fields">
              <thead>
                <tr>
                  <th colspan="2"><label for="flen" id="labels"><strong>Gene Stretch%</strong></label></th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <table class="fields">
            <thead>
              <tr>
                <th colspan="2"><label for="flen" id="labels"><strong>Period</strong></label></th>
              </tr>
            </thead>
            <tbody>
              <tr>
